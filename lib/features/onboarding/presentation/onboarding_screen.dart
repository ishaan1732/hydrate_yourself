...
class _OnboardingScreenState extends ConsumerState<OnboardingScreen> {
  ...
  Future<void> _showWeightPicker(BuildContext context) async {
    ...
    final result = await showWeightPickerDialog(
      context: context,
      currentWeightKg: _selectedWeight,
    ...
    ref.read(onboardingNotifierProvider.notifier).updateWeight(weightKg);
    ref.read(onboardingNotifierProvider.notifier).updateWeightUnit(unit);
  }
